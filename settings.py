bot = {
    'token': open('1897184600:AAG6sqKSDX1VzxiCGP4vmbGXnywgxEJmPDM', 'r').readline(), # Bot token
    'admin': int(open('1160089400', 'r').readline()), # Admin id
    'allowed_users': list(map(lambda x: int(x.strip('\n')), open('1160089400', 'r').readlines())) # List ids of allowed users
}
